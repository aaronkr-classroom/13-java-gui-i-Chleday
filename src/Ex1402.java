...
public class Ex1402 {
		...
		public static void main(String[] args) {
			...
			// 버튼 추가하기
			JButton btn1 = new JButton("코카콜라", new ImageIcon("img/coca-cola.png"));
			JButton btn2 = new JButton("다이어트 콜라", new ImageIcon("img/Diet Coke.png"));
			JButton btn3 = new JButton("제로콜라", new ImageIcon("img/Coke zero.png"));
			btn1.setSize(64,64);
			btn2.setSize(64,64);
			btn3.setSize(64,64);
			panel.add(btn1);
